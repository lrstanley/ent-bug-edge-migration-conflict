...
const (
	...
	GuildsTable = "user_guilds"
	// GuildsInverseTable is the table name for the UserGuild entity.
	// It exists in this package in order to avoid circular dependency with the "userguild" package.
	GuildsInverseTable = "user_guilds"
)
...
var (
	...
	GuildsPrimaryKey = []string{"user_id", "user_guild_id"}
)
