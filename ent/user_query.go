...
func (uq *UserQuery) QueryGuilds() *UserGuildQuery {
	query := &UserGuildQuery{config: uq.config}
...
func (uq *UserQuery) WithGuilds(opts ...func(*UserGuildQuery)) *UserQuery {
	query := &UserGuildQuery{config: uq.config}
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withGuilds; query != nil {
		if err := uq.loadGuilds(ctx, query, nodes,
			func(n *User) { n.Edges.Guilds = []*UserGuild{} },
			func(n *User, e *UserGuild) { n.Edges.Guilds = append(n.Edges.Guilds, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (uq *UserQuery) loadGuilds(ctx context.Context, query *UserGuildQuery, nodes []*User, init func(*User), assign func(*User, *UserGuild)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(userguild.FieldID), joinT.C(user.GuildsPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(user.GuildsPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(user.GuildsPrimaryKey[0]))
